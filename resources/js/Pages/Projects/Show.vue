                             ...
                             <div class="m-2">
                                ...
                                <div class="p-2">
                                    <div id="name" class="w-full  bg-blue-50 rounded border focus:bg-white focus:ring-2 text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        ◆　{{ project.name }}　『{{ project.yard }}　No. {{ project.project_no }}』
                                    </div>
                                </div>
                               ...
                               <vue-collapsible-panel>
                                ...
                                <template #content> 
                                  ...
                                  <div class="flex flex-wrap sm:flex-row">
                                    <div v-if="project.ex_name" class="p-2 ml-4">
                                    ...
                                    <div v-if="project.former_name" class="p-2 ml-4">
                                    ...
                                    <div class="p-2 ml-4">
                                      ...
                                      <div id="name" class="w-48  text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            {{ props.project.operat_sections.section }}
                                      </div>
                                    </div>
                                    <div class="p-2 ml-4">
                                      <label for="name" class=" rounded  border border-indigo-300 px-1  leading-7 text-sm text-gray-600">◎航行区域 :</label>
                                      <div id="name" class="w-48   text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                          {{ props.project.navigation_areas.name }}<a v-if="props.project.navigation_areas.name"> 区域</a>
                                      </div>
                                    </div>
                                    ...
                                    <div class="p-2 ml-4">
                                      ...
                                      <div id="name" class="w-48  text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                            {{ props.project.summary2s.insurance_type }}
                                      </div>
                                    </div> 
                                  </div>
                                </template>
                            ...
                            <template #content>
                              <div class="md:flex">
                                  <div class="p-2">
                                    ...
                                    {{ props.project.summaries.full_length }}<a v-if="props.project.summaries.full_length"> ｍ</a>
                                    </div>
                                  </div>
                                  <div class="p-2">
                                    <label for="name" class=" rounded  border border-indigo-300 px-1  leading-7 text-sm text-gray-600">◎垂線間長：</label>
                                    <div id="name" class="w-48  text-base outline-none text-gray-700 py-0 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        {{ props.project.summaries.lpp }}<a v-if="props.project.summaries.lpp"> ｍ</a>
                                    </div>
                                  </div>
                                </div>
                            <div class="md:flex">
                                  <div class="p-2">
                                    ...
                                    <div id="name" class="w-48  text-base outline-none text-gray-700 py-0 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        {{ props.project.summaries.breadth }}<a v-if="props.project.summaries.breadth"> ｍ</a>
                                    </div>
                                  </div>
                                  <div class="p-2">
                                    <label for="name" class=" rounded  border border-indigo-300 px-1  leading-7 text-sm text-gray-600">◎型深さ :</label>
                                    <div id="name" class="w-48   text-base outline-none text-gray-700 py-0 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                    {{ props.project.summaries.beam_depth }}<a v-if="props.project.summaries.beam_depth"> ｍ</a>
                                    </div>
                                  </div>
                                </div>
                                <div class="md:flex">
                                      ...
                                      <table class="min-w-full text-left text-sm font-light">
                                        ...
                                        <tbody>
                                          <tr class="border-b dark:border-neutral-500">
                                            ...
                                            <td class="whitespace-nowrap pr-28 py-4 text-right">{{ props.project.summary2s.speed50 }}</td>
                                            <td class="whitespace-nowrap pr-28 py-4 text-right">{{ props.project.summary2s.speed100 }}</td>
                                          </tr>
                                          <tr class="border-b dark:border-neutral-500">
                                            <td class="whitespace-nowrap px-12 py-4 font-medium">ペラ回転数</td>
                                            <td class="whitespace-nowrap pr-28 py-4 text-right"> {{ props.project.summary2s.rpm_peller50 }}</td>
                                            <td class="whitespace-nowrap pr-28 py-4 text-right"> {{ props.project.summary2s.rpm_peller100 }}</td>
                                          </tr>
                                          <tr class="border-b dark:border-neutral-500">
                                            <td class="whitespace-nowrap px-12 py-4 font-medium">スリップ</td>
                                            <td class="whitespace-nowrap pr-28 py-4 text-right">{{ props.project.summary2s.slip_rate50 }}</td>
                                            <td class="whitespace-nowrap pr-28 py-4 text-right" >{{ props.project.summary2s.slip_rate100 }}</td>
                                          </tr>
                                          <tr class="border-b dark:border-neutral-500">
                                            <td class="whitespace-nowrap px-12 py-4 font-medium">行進引力（平均）</td>
                                            <td class="whitespace-nowrap pr-28 py-4 text-right"> {{ props.project.summary2s.tug_force50 }}</td>
                                            <td class="whitespace-nowrap pr-28 py-4 text-right"> {{ props.project.summary2s.tug_force100 }}</td>
                                          </tr>
                                        </tbody>
                                      </table>
                                    </div>
                                      ...
                                      <table class="min-w-full text-left text-sm font-light">
                                        ...
                                        <tbody>
                                          <tr class="border-b dark:border-neutral-500">
                                            ...
                                            <td class="whitespace-nowrap pr-28 py-4 text-right">{{ props.project.concerneds.operator }}</td>
                                          </tr>
                                          <tr class="border-b dark:border-neutral-500">
                                            <td class="whitespace-nowrap px-12 py-4 font-medium">船舶借入人</td>
                                            <td class="whitespace-nowrap pr-28 py-4 text-right"> {{ props.project.concerneds.borrower }}</td>
                                          </tr>
                                          <tr class="border-b dark:border-neutral-500">
                                            <td class="whitespace-nowrap px-12 py-4 font-medium">船舶管理人</td>
                                            <td class="whitespace-nowrap pr-28 py-4 text-right">{{ props.project.concerneds.manager }}</td>
                                          </tr>
                                          <tr class="border-b dark:border-neutral-500">
                                            <td class="whitespace-nowrap px-12 py-4 font-medium">乗組員手配</td>
                                            <td class="whitespace-nowrap pr-28 py-4 text-right"> {{ props.project.concerneds.crew_arrange }}</td>
                                          </tr>
                                        </tbody>
                                      </table>
                                    </div>
                                  ...
                                  <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                                    <div class="overflow-hidden">
                                      <table class="min-w-full text-left text-sm font-light">
                                        ...
                                        <tbody>
                                          <tr v-for="projectOwner in props.project.project_owners" class="border-b dark:border-neutral-500">
                                            <td class="whitespace-nowrap px-12 py-4 text-center">{{ projectOwner.owner_name }}</td>
                                            <td class="whitespace-nowrap pr-36 py-4 text-right">{{ projectOwner.ratio }}</td>
                                          </tr>
                                        </tbody>
                                      </table>
                                    </div>
                                  ...
                                  <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                                    <div class="overflow-hidden">
                                      <table class="min-w-full text-left text-sm font-light">
                                        ...
                                        <tbody>
                                          <tr v-for="attachment in  props.project.project_attachments" :key="attachment.id" class="border-b dark:border-neutral-500">
